defmodule LearningPhoenix.PromotionsTest do
  use LearningPhoenix.DataCase

  alias LearningPhoenix.Promotions

  describe "promotions" do
    alias LearningPhoenix.Promotions.Promotion

    import LearningPhoenix.PromotionsFixtures
    ...
    test "create_promotion/1 with valid data creates a promotion" do
      valid_attrs = %{code: "some code", name: "some name", expires_at: ~U[2025-05-05 18:00:00Z]}
      ...
      # assert promotion.expires_at == ~U[2025-05-05 18:00:00Z]
    end
    ...
    test "update_promotion/2 with valid data updates the promotion" do
      ...
      update_attrs = %{
        ...
        # expires_at: ~U[2025-05-06 18:00:00Z]
      }
      ...
      # assert promotion.expires_at == ~U[2025-05-06 18:00:00Z]
    end
